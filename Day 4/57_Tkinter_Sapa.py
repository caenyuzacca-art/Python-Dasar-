...
#Fungsi
def tombol_click():
    pesan=f"Heloo {NAMA_DEPAN.get()} {NAMA_BELAKANG.get()}, Have nice day"
...
input_frame.pack(padx=10, pady=10, fill="x", expand=True) #membuat pack layout dengan pack
...
nama_belakang_label = ttk.Label(input_frame, text="Nama Belakang:") #label tetx aisha pada frame input
